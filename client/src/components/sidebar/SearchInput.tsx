...
const SearchInput = () => {
  ...
  const handleSubmit = (e : any) =>{
    ...
    if(search.length < 3)
    return toast.error("Searched name should have  at least 3 characters");

    const conversation = conversations.find((c) => c.nickname.toLowerCase().includes(search.toLowerCase()))
